...
-- CreateTable
CREATE TABLE "conversations"."message" (
    "id" SERIAL NOT NULL,
...
-- CreateTable
CREATE TABLE "conversations"."conversations_users" (
    "id" SERIAL NOT NULL,
    "user" TEXT NOT NULL,
    "conversation_id" INTEGER NOT NULL,
    "joined_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "left_at" TIMESTAMP(3) NOT NULL,
    "limited_access" BOOLEAN NOT NULL,
    "access_since" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "sessions_uuid_key" ON "user_management"."sessions"("uuid");
...
-- AddForeignKey
ALTER TABLE "conversations"."message" ADD CONSTRAINT "message_conversation_id_fkey" FOREIGN KEY ("conversation_id") REFERENCES "conversations"."conversations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
