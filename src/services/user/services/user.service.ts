    ...
    try {
      const newUser = await this.prisma.user.create({
        data: {
          ...
          preferredUsername: signupDto.preferredUsername,
          passwordHash: hash,
          country: signupDto.country,
          address: signupDto.address,
          phoneNumer: signupDto.phoneNumber,
        },
        select: {
          uuid: true,
          username: true,
    ...
    try {
      const updatedUser = await this.prisma.user.update({
        ...
        data: {
          ...
          preferredUsername: updateUserDto.preferredUsername,
          country: updateUserDto.country,
          address: updateUserDto.address,
          phoneNumer: updateUserDto.phoneNumber,
        },
        select: {
          uuid: true,
          username: true,
